...
export default function ProfileCard({
  ...
  useEffect(() => {
    ...
    const handleClick = () => {
      ...
      const anyMotion = (window as unknown as { DeviceMotionEvent?: MotionEventCtor }).DeviceMotionEvent;
            ...
            <div className="pc-content pc-avatar-content">
              ...
              {showUserInfo && (
                <div className="pc-user-info">
                  ...
                  <button className="pc-contact-btn" onClick={onContactClick} style={{ pointerEvents: "auto" }} type="button" aria-label={`${contactText} — ${name || "user"}`}>
                    {contactText}
                  </button>
                </div>
              )}
